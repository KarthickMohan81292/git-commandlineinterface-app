...
* The original package name 'com.git.commandlineinterface-app' is invalid and this project uses 'com.git.commandlineinterfaceapp' instead.
...
```
$ docker run --rm commandlineinterface-app:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/commandlineinterface-app
```
